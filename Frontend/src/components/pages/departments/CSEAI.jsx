...
function CSEAI() {
  ...
  return (
    <div className='templateContainer' style={{ backgroundImage: 'url(https://tse4.mm.bing.net/th?id=OIP.z9vQwb9fX6aB6KX3E-rd9gHaE0&pid=Api&P=0&h=180)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className='searchInput_Container'>
        <input type='text' placeholder='Search batch...' onChange={(event)=>{
